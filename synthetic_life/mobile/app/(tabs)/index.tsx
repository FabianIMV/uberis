...
export default function WorldScreen() {
  const { entities, worldState, connected } = useEntities()
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerSub}>
            {entities.length} alive · tick {worldState?.current_tick ?? 0}
          </Text>
        </View>
      ...
      {/* Cultural beliefs */}
      {worldState?.cultural_beliefs && Object.keys(worldState.cultural_beliefs).length > 0 && (
